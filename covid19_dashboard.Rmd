...
```{r}
helpText("Selecione o Estado e a estatistica a ser apresentada.")

selectInput("estado",h3("Estados"),choices = est_selecoes, selected = "Todos os Estados", multiple = FALSE)
